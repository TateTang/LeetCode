...
public class Offer54 {
    public static void main(String[] args) {
        ...
        System.out.println(new Offer54().minNumber(nums));
    }
    ...
    public String minNumber(int[] nums) {
        ...
        //比较两个字符串的大小，然后进行升序排列。所以[3,30,34]排序后变为[34,3,30]，[233，23333]排序后变为[23333，233],
        /*
